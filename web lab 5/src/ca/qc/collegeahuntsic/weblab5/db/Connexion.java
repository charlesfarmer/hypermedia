...
package ca.qc.collegeahuntsic.weblab5.db;
...
public class Connexion implements AutoCloseable {
	...
	// private static final String SERVEUR_DISTANT_URL =
	// "jdbc:oracle:thin:@collegeahunstic.info:1521:";
	 ...
	 * 
	 * @param typeServeur
	 *            Type de serveur SQL de la BD
	 * @param schema
	 *            Nom du schéma de la base de données
	 * @param nomUtilisateur
	 *            Nom d'utilisateur sur le serveur SQL
	 * @param motPasse
	 *            Mot de passe sur le serveur SQL
	 * @throws ConnexionException
	 *             Si le driver n'existe pas, S'il y a une erreur avec la base
	 *             de données ou si <code>typeServeur</code> n'est pas valide
	 */
	public Connexion(String typeServeur, String schema, String nomUtilisateur,
	...
	public void close() throws SQLException {
		rollback();
		getConnection().close();
		System.out.println("\nConnexion fermée" + " " + getConnection());
	}

	/**
	 * Effectue un commit sur la {@link java.sql.Connection} JDBC.
	 * 
	 * @throws {@link java.sql.SQLException} S'il y a une erreur avec la base de
	 *         données
	 */
	 ...
	 * <code>distant</code> : Oracle installé au Département d'Informatique du
	 * Collège Ahuntsic<br />
	 * <code>postgres</code> : Postgres installé localement<br />
	 * <code>access</code> : Microsoft Access installé localement et inscrit
	 * dans ODBC
	 * 
