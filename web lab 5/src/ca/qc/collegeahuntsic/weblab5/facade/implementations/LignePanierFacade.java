...
public class LignePanierFacade extends Facade implements ILignePanierFacade {
	...
	public LignePanierBean ajouterAuPanier(Connexion connexion,
		...
		try {
			return getService().ajouterAuPanier(connexion, lignePanierBean);
	...
	public void retirerDuPanier(Connexion connexion,
		...
		try {
			getService().delete(connexion, lignePanierBean);
		} catch (ServiceException e) {
			throw new FacadeException(e);
		}
	}
	...
	public List<LignePanierBean> getPanier(Connexion connexion,
		...
		try {
			return getService().findByClient(connexion, clientBean);
		} catch (ServiceException e) {
			throw new FacadeException(e);
		}
	}
	...
	@Override
	public void viderPanier(Connexion connexion, ClientBean clientBean)
			throws FacadeException {
		try {
			getService().deleteByClient(connexion, clientBean);
		} catch (ServiceException e) {
			throw new FacadeException(e);
		}
	}
