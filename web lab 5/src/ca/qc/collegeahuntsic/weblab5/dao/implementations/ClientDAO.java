...
public class ClientDAO extends DAO implements IClientDAO {
	...
	public ClientDAO(Class<ClientBean> beanClass)
	...
	public Bean add(Connexion connexion, Bean bean)
		...
		try {
			...
			try (PreparedStatement createPreparedStatement = connexion
					.getConnection().prepareStatement(ClientDAO.CREATE_REQUEST)) {
				clientBean.setIdClient(ClientDAO.getPrimaryKey(connexion));
				createPreparedStatement.setString(1, clientBean.getIdClient());
				createPreparedStatement.setString(2, clientBean.getEmail());
				createPreparedStatement.setString(3, clientBean.getPassword());
				createPreparedStatement.setString(4, clientBean.getProfilBean()
						.getIdProfil());
	...
	@Override
	public ClientBean get(Connexion connexion, Serializable primaryKey)
			throws DAOException {
		try {
			if (connexion == null) {
				throw new InvalidHibernateSessionException(
			...
			try (PreparedStatement readPreparedStatement = connexion
					.getConnection().prepareStatement(ClientDAO.READ_REQUEST)) {
	...
	public void update(Connexion connexion, Bean bean)
		...
		try {
			...
			try (PreparedStatement updatePreparedStatement = connexion
					.getConnection().prepareStatement(ClientDAO.UPDATE_REQUEST)) {
				updatePreparedStatement.setString(1, clientBean.getIdClient());
				updatePreparedStatement.setString(2, clientBean.getEmail());
				updatePreparedStatement.setString(3, clientBean.getPassword());
				updatePreparedStatement.setString(4, clientBean.getProfilBean()
						.getIdProfil());
				updatePreparedStatement.setString(5, clientBean.getIdClient());
	...
	public void delete(Connexion connexion, Bean bean)
		...
		try {
			...
			try (PreparedStatement deletePreparedStatement = connexion
					.getConnection().prepareStatement(ClientDAO.DELETE_REQUEST)) {
				deletePreparedStatement.setString(1, clientBean.getIdClient());
	...
	@Override
	public List<ClientBean> getAll(Connexion connexion, String sortByPropertyName)
			throws DAOException {
		try {
			if (connexion == null) {
				throw new InvalidHibernateSessionException(
			...
			try (PreparedStatement getAllPreparedStatement = connexion
					.getConnection().prepareStatement(ClientDAO.GET_ALL_REQUEST)) {
	...
	private static String getPrimaryKey(Connexion connexion)
			throws DAOException {
		return DAO.getPrimaryKey(connexion, ClientDAO.CREATE_PRIMARY_KEY);
	}

	@Override
	public ClientBean findByEmail(Connexion connexion, String email) throws DAOException {
		try {
			if(connexion == null) {
