...
public class StockDAO extends DAO implements IStockDAO {
    ...
    public StockDAO(Class<StockBean> beanClass) throws InvalidDTOClassException {
        super(beanClass);
    }
    ...
    public Bean add(Connexion connexion,
        ...
        try {
            ...
            try(
                PreparedStatement createPreparedStatement = connexion.getConnection().prepareStatement(StockDAO.CREATE_REQUEST)) {
                ...
                createPreparedStatement.setInt(2,
                    stockBean.getQuantite());
                createPreparedStatement.setBigDecimal(3,
                    stockBean.getPrix());
                createPreparedStatement.setBigDecimal(4,
                    stockBean.getRabais());
    ...
    public StockBean get(Connexion connexion,
        ...
        try {
            ...
            try(
                PreparedStatement readPreparedStatement = connexion.getConnection().prepareStatement(StockDAO.READ_REQUEST)) {
    ...
    public void update(Connexion connexion,
        ...
        try {
            ...
            StockBean stockBean = (StockBean) bean;
            try(
                PreparedStatement updatePreparedStatement = connexion.getConnection().prepareStatement(StockDAO.UPDATE_REQUEST)) {
                updatePreparedStatement.setString(1,
                    stockBean.getIdStock());
                updatePreparedStatement.setInt(2,
                    stockBean.getQuantite());
                updatePreparedStatement.setBigDecimal(3,
                    stockBean.getPrix());
                updatePreparedStatement.setBigDecimal(4,
                    stockBean.getRabais());
    ...
    public void delete(Connexion connexion,
        ...
        try {
            ...
            StockBean stockBean = (StockBean) bean;
            try(
                PreparedStatement deletePreparedStatement = connexion.getConnection().prepareStatement(StockDAO.DELETE_REQUEST)) {
    ...
    @Override
    public List<StockBean> getAll(Connexion connexion,
        ...
        try {
            ...
            try(
                PreparedStatement getAllPreparedStatement = connexion.getConnection().prepareStatement(StockDAO.GET_ALL_REQUEST)) {
                try(
