...
public class LigneFactureDAO extends DAO implements ILigneFactureDAO {
	...
	public LigneFactureDAO(Class<LigneFactureBean> beanClass)
	...
	public Bean add(Connexion connexion, Bean bean)
		...
		try {
			...
			try (PreparedStatement createPreparedStatement = connexion
					.getConnection().prepareStatement(LigneFactureDAO.CREATE_REQUEST)) {
				ligneFactureBean.setIdLigneFacture(LigneFactureDAO.getPrimaryKey(connexion));
				createPreparedStatement.setString(1, ligneFactureBean.getIdLigneFacture());
				createPreparedStatement.setString(2, ligneFactureBean.getAchatBean().getIdAchat());
				createPreparedStatement.setString(3, ligneFactureBean.getProduitBean().getIdProduit());
				createPreparedStatement.setInt(4, ligneFactureBean.getQuantite());
				createPreparedStatement.setBigDecimal(5, ligneFactureBean.getPrix());
	...
	@Override
	public LigneFactureBean get(Connexion connexion, Serializable primaryKey)
			throws DAOException {
		try {
			if (connexion == null) {
				throw new InvalidHibernateSessionException(
			...
			try (PreparedStatement readPreparedStatement = connexion
					.getConnection().prepareStatement(LigneFactureDAO.READ_REQUEST)) {
	...
	public void update(Connexion connexion, Bean bean)
		...
		try {
			...
			try (PreparedStatement updatePreparedStatement = connexion
					.getConnection().prepareStatement(LigneFactureDAO.UPDATE_REQUEST)) {
				updatePreparedStatement.setString(1, ligneFactureBean.getIdLigneFacture());
				updatePreparedStatement.setString(2, ligneFactureBean.getAchatBean().getIdAchat());
				updatePreparedStatement.setString(3, ligneFactureBean.getProduitBean().getIdProduit());
				updatePreparedStatement.setInt(4, ligneFactureBean.getQuantite());
				updatePreparedStatement.setBigDecimal(5, ligneFactureBean.getPrix());
				updatePreparedStatement.setString(6, ligneFactureBean.getIdLigneFacture());
	...
	public void delete(Connexion connexion, Bean bean)
		...
		try {
			...
			try (PreparedStatement deletePreparedStatement = connexion
					.getConnection().prepareStatement(LigneFactureDAO.DELETE_REQUEST)) {
				deletePreparedStatement.setString(1, ligneFactureBean.getIdLigneFacture());
	...
	@Override
	public List<LigneFactureBean> getAll(Connexion connexion, String sortByPropertyName)
			throws DAOException {
		try {
			if (connexion == null) {
				throw new InvalidHibernateSessionException(
			...
			try (PreparedStatement getAllPreparedStatement = connexion
					.getConnection().prepareStatement(LigneFactureDAO.GET_ALL_REQUEST)) {
	...
	private static String getPrimaryKey(Connexion connexion)
			throws DAOException {
			return DAO.getPrimaryKey(connexion, LigneFactureDAO.CREATE_PRIMARY_KEY);
	}
	...
	public List<LigneFactureBean> findByAchat(Connexion connexion,
		...
		try {
			...
			try (PreparedStatement findByAchatPreparedStatement = connexion
					.getConnection().prepareStatement(LigneFactureDAO.FIND_BY_ACHAT_REQUEST)) {
				findByAchatPreparedStatement.setString(1, achatBean.getIdAchat());
				try (ResultSet resultSet = findByAchatPreparedStatement.executeQuery()) {
					LigneFactureBean ligneFactureBean = null;
					if (resultSet.next()) {
		...
		}catch(SQLException | InvalidHibernateSessionException | InvalidDAOException sqlException) {
