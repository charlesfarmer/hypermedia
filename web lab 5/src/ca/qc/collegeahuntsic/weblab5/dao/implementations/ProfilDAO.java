...
public class ProfilDAO extends DAO implements IProfilDAO {
    ...
    public ProfilDAO(Class<ProfilBean> beanClass) throws InvalidDTOClassException {
        super(beanClass);
    }
    ...
    public Bean add(Connexion connexion,
        ...
        try {
            ...
            try(
                PreparedStatement createPreparedStatement = connexion.getConnection().prepareStatement(ProfilDAO.CREATE_REQUEST)) {
    ...
    public ProfilBean get(Connexion connexion,
        ...
        try {
            ...
            try(
                PreparedStatement readPreparedStatement = connexion.getConnection().prepareStatement(ProfilDAO.READ_REQUEST)) {
    ...
    public void update(Connexion connexion,
        ...
        try {
            ...
            ProfilBean profilBean = (ProfilBean) bean;
            try(
                PreparedStatement updatePreparedStatement = connexion.getConnection().prepareStatement(ProfilDAO.UPDATE_REQUEST)) {
    ...
    public void delete(Connexion connexion,
        ...
        try {
            ...
            ProfilBean profilBean = (ProfilBean) bean;
            try(
                PreparedStatement deletePreparedStatement = connexion.getConnection().prepareStatement(ProfilDAO.DELETE_REQUEST)) {
    ...
    public List<ProfilBean> getAll(Connexion connexion,
        ...
        try {
            ...
            try(
                PreparedStatement getAllPreparedStatement = connexion.getConnection().prepareStatement(ProfilDAO.GET_ALL_REQUEST)) {
                try(
