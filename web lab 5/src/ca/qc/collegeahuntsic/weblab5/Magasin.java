...
public class Magasin {
	...
	public static void main(String[] args) {
		...
		try {
			...
			MagasinCreateur gestionMagasin = new MagasinCreateur(args[0], args[1], args[2], args[3]);
			...
			try {
				...
				profilBean = (ProfilBean) gestionMagasin.getProfilService().add(gestionMagasin.getConnexion(), profilBean);
				clientBean = (ClientBean) gestionMagasin.getClientService().add(gestionMagasin.getConnexion(), clientBean);
				stockBean = (StockBean) gestionMagasin.getStockService().add(gestionMagasin.getConnexion(), stockBean);
				produitBean = (ProduitBean) gestionMagasin.getProduitService().add(gestionMagasin.getConnexion(), produitBean);
				achatBean = (AchatBean) gestionMagasin.getAchatService().add(gestionMagasin.getConnexion(), achatBean);			
				lignePanierBean = (LignePanierBean) gestionMagasin.getLignePanierService().add(gestionMagasin.getConnexion(), lignePanierBean);
				ligneFactureBean = (LigneFactureBean) gestionMagasin.getLigneFactureService().add(gestionMagasin.getConnexion(), ligneFactureBean);
				
				gestionMagasin.getProfilService().update(gestionMagasin.getConnexion(), profilBean);
				gestionMagasin.getClientService().update(gestionMagasin.getConnexion(), clientBean);
				gestionMagasin.getStockService().update(gestionMagasin.getConnexion(), stockBean);
				gestionMagasin.getProduitService().update(gestionMagasin.getConnexion(), produitBean);
				gestionMagasin.getAchatService().update(gestionMagasin.getConnexion(), achatBean);			
				gestionMagasin.getLignePanierService().update(gestionMagasin.getConnexion(), lignePanierBean);
				gestionMagasin.getLigneFactureService().update(gestionMagasin.getConnexion(), ligneFactureBean);
				...
				//*
				gestionMagasin.getLignePanierService().delete(gestionMagasin.getConnexion(), lignePanierBean);
				gestionMagasin.getLigneFactureService().delete(gestionMagasin.getConnexion(), ligneFactureBean);
				gestionMagasin.getProduitService().delete(gestionMagasin.getConnexion(), produitBean);
				gestionMagasin.getStockService().delete(gestionMagasin.getConnexion(), stockBean);
				gestionMagasin.getAchatService().delete(gestionMagasin.getConnexion(), achatBean);
				gestionMagasin.getClientService().delete(gestionMagasin.getConnexion(), clientBean);
				gestionMagasin.getProfilService().delete(gestionMagasin.getConnexion(), profilBean);
