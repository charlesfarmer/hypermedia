...
public interface IClientService extends IService {
	ClientBean add(Connexion connexion, ClientBean clientBean) throws ServiceException;
	ClientBean get(Connexion connexion, ClientBean clientBean) throws ServiceException;
