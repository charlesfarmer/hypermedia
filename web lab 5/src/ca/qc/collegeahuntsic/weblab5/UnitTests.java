...
public class UnitTests {
	...
	public static void main(String[] args) {
		try {
			...
			MagasinCreateur magasin = new MagasinCreateur(args[0], args[1],
					args[2], args[3]);
	...
	private static void unitTestLigneFacture(MagasinCreateur magasin)
			throws ServiceException, MagasinException {
		...
		ligneFactureBean.setPrix(ligneFactureBean.getProduitBean()
				.getStockBean().getPrix());

		ligneFactureBean = magasin.getLigneFactureService().add(
				magasin.getConnexion(), ligneFactureBean);

		System.out.println("\n\n##### ADD \n\n" + ligneFactureBean.toString());

		ligneFactureBean = magasin.getLigneFactureService().get(
				magasin.getConnexion(), ligneFactureBean);
		...
		System.out.println("\n\n##### FIND BY ACHAT\n\n");
		for (LigneFactureBean b : magasin.getLigneFactureService().findByAchat(
				magasin.getConnexion(), achatBean)) {
	...
	private static void unitTestAchat(MagasinCreateur magasin)
	...
	private static void unitTestLignePanier(MagasinCreateur magasin)
		...
		lignePanierBean = magasin.getLignePanierService().get(
				magasin.getConnexion(), lignePanierBean);
		...
		System.out.println("\n\n##### FIND BY CLIENT \n\n");
		for (LignePanierBean b : magasin.getLignePanierService().findByClient(
				magasin.getConnexion(), lignePanierBean.getClientBean())) {
			System.out.println(b.toString());
		}
	...
	private static void unitTestProduit(MagasinCreateur magasin)
			throws ServiceException {
		ProduitBean produitBean = new ProduitBean();
		produitBean.setDescription("meow");
		produitBean.setNom("shamWOW");
	...
	private static void unitTestStock(MagasinCreateur magasin)
			throws ServiceException {
		StockBean stockBean = new StockBean();
		stockBean.setPrix(new BigDecimal(10));
		stockBean.setQuantite(5);
	...
	private static void unitTestProfil(MagasinCreateur magasin)
			throws ServiceException {
		ProfilBean profilBean = new ProfilBean();
		profilBean.setNom("Georges");
		profilBean.setPrenom("Power");
	...
	private static void unitTestClient(MagasinCreateur magasin)
			throws ServiceException {
		ClientBean clientBean = new ClientBean();
		clientBean.setEmail("a@a.a");
		clientBean.setPassword("1234");
		...
		clientBean = magasin.getClientService().findByEmail(
				magasin.getConnexion(), clientBean.getEmail());
