package ca.qc.collegeahuntsic.weblab5.exception;

/**
 * Cette exception est utilisée en cas de problème avec l'objet {@link ca.qc.collegeahuntsic.weblab5.util.Magasin}.
 *
...
public class MagasinException extends Exception {
     ...
     */
    public MagasinException(String message) {
        super(message);
    }
     ...
     */
    public MagasinException(Throwable cause) {
        super(cause);
    }
