...
public interface IFavoriService extends IService {
	...
	List<FavoriDTO> getAllFavoris(Session session, String sortByPropertyName)
			throws InvalidHibernateSessionException,
			InvalidSortByPropertyException, ServiceException;

	void deleteFavori(Session session, FavoriDTO favoriDTO)
			throws InvalidHibernateSessionException, InvalidDTOException,
			ServiceException;

	void updateFavori(Session session, FavoriDTO favoriDTO)
			throws InvalidHibernateSessionException, InvalidDTOException,
			ServiceException;

	FavoriDTO getFavori(Session session, String idFavori)
			throws InvalidHibernateSessionException,
			InvalidPrimaryKeyException, ServiceException;

	void addFavori(Session session, FavoriDTO favoriDTO)
			throws InvalidHibernateSessionException, InvalidDTOException,
			ServiceException;

	void ajouterFavori(Session session, FavoriDTO favoriDTO)
			throws InvalidHibernateSessionException, InvalidDTOException,
