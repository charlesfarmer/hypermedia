...
public class VitrineService extends Service implements IVitrineService {
    ...
    @Override
    public void addVitrine(Session session,
        VitrineDTO vitrineDTO) throws InvalidHibernateSessionException,
        InvalidDTOException,
        ServiceException {
        try {
            getVitrineDAO().add(session,
                vitrineDTO);
    ...
    @Override
    public VitrineDTO getVitrine(Session session,
        String idVitrine) throws InvalidHibernateSessionException,
        InvalidPrimaryKeyException,
        ServiceException {
        try {
            return (VitrineDTO) getVitrineDAO().get(session,
                idVitrine);
        } catch(DAOException daoException) {
            throw new ServiceException(daoException);
        }
    ...
    @Override
    public void updateVitrine(Session session,
        VitrineDTO vitrineDTO) throws InvalidHibernateSessionException,
        InvalidDTOException,
        ServiceException {
        try {
            getVitrineDAO().update(session,
                vitrineDTO);
        } catch(DAOException daoException) {
            throw new ServiceException(daoException);
        }
    ...
    @Override
    public void deleteVitrine(Session session,
        VitrineDTO vitrineDTO) throws InvalidHibernateSessionException,
        InvalidDTOException,
        ServiceException {
        try {
            getVitrineDAO().delete(session,
                vitrineDTO);
        } catch(DAOException daoException) {
            throw new ServiceException(daoException);
        }
    ...
    @Override
    public void ajouterVitrine(Session session,
        VitrineDTO vitrineDTO) throws InvalidHibernateSessionException,
        InvalidDTOException,
        VitrineAlreadyAddedException,
        ServiceException {
