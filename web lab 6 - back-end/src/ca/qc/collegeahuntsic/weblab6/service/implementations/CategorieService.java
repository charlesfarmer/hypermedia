...
public class CategorieService extends Service implements ICategorieService {
	...
	@Override
	public void addCategorie(Session session, CategorieDTO categorieDTO)
			throws InvalidHibernateSessionException, InvalidDTOException,
			ServiceException {
		try {
			getCategorieDAO().add(session, categorieDTO);
	...
	@Override
	public CategorieDTO getCategorie(Session session, String idCategorie)
			throws InvalidHibernateSessionException,
			InvalidPrimaryKeyException, ServiceException {
		try {
			return (CategorieDTO) getCategorieDAO().get(session, idCategorie);
		} catch (DAOException daoException) {
			throw new ServiceException(daoException);
		}
	}
	...
	@Override
	public void updateCategorie(Session session, CategorieDTO categorieDTO)
			throws InvalidHibernateSessionException, InvalidDTOException,
			ServiceException {
		try {
			getCategorieDAO().update(session, categorieDTO);
		} catch (DAOException daoException) {
			throw new ServiceException(daoException);
		}
	}
	...
	@Override
	public void deleteCategorie(Session session, CategorieDTO categorieDTO)
			throws InvalidHibernateSessionException, InvalidDTOException,
			ServiceException {
		try {
			getCategorieDAO().delete(session, categorieDTO);
		} catch (DAOException daoException) {
			throw new ServiceException(daoException);
		}
	}
	...
	@SuppressWarnings("unchecked")
	@Override
	public void ajouterCategorie(Session session, CategorieDTO categorieDTO)
			throws InvalidHibernateSessionException, InvalidDTOException,
			CategorieAlreadyAddedException, ServiceException {
		List<CategorieDTO> categories = (List<CategorieDTO>) categorieDTO
				.getMembreDTO().getCategories();
		...
		addCategorie(session, categorieDTO);
	}
