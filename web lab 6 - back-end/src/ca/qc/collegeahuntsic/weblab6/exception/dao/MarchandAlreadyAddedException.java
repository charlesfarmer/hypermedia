...
public class MarchandAlreadyAddedException extends Exception {
     ...
     */
    public MarchandAlreadyAddedException() {
        super();
    }
     ...
     */
    public MarchandAlreadyAddedException(String message) {
        super(message);
    }
     ...
     */
    public MarchandAlreadyAddedException(Throwable cause) {
        super(cause);
    }
