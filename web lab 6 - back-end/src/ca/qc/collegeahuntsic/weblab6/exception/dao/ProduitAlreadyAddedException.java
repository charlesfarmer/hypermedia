...
public class ProduitAlreadyAddedException extends Exception {
     ...
     */
    public ProduitAlreadyAddedException() {
        super();
    }
     ...
     */
    public ProduitAlreadyAddedException(String message) {
        super(message);
    }
     ...
     */
    public ProduitAlreadyAddedException(Throwable cause) {
        super(cause);
    }
