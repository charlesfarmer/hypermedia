...
public class CategorieAlreadyAddedException extends Exception {
     ...
     */
    public CategorieAlreadyAddedException() {
        super();
    }
     ...
     */
    public CategorieAlreadyAddedException(String message) {
        super(message);
    }
     ...
     */
    public CategorieAlreadyAddedException(Throwable cause) {
        super(cause);
    }
