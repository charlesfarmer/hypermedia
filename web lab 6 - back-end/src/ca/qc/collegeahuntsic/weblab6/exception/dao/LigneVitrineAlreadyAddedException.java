...
public class LigneVitrineAlreadyAddedException extends Exception {
     ...
     */
    public LigneVitrineAlreadyAddedException() {
        super();
    }
     ...
     */
    public LigneVitrineAlreadyAddedException(String message) {
        super(message);
    }
     ...
     */
    public LigneVitrineAlreadyAddedException(Throwable cause) {
        super(cause);
    }
