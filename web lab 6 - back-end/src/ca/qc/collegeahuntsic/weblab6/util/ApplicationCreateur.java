...
public class ApplicationCreateur {
    ...
    private static final String[] APPLICATION_CONTEXT_FILENAMES = new String[] {APPLICATION_CONTEXT_JDBC_FILENAME,
        APPLICATION_CONTEXT_DTO_FILENAME,
        APPLICATION_CONTEXT_DAO_FILENAME,
        APPLICATION_CONTEXT_SERVICE_FILENAME,
    ...
    public ApplicationCreateur() throws ApplicationException {
        super();
        try {
            setSessionFactory((SessionFactory) ApplicationCreateur.APPLICATION_CONTEXT.getBean(ApplicationCreateur.SESSION_FACTORY_NAME));
            setCategorieService((ICategorieService) ApplicationCreateur.APPLICATION_CONTEXT.getBean(ApplicationCreateur.CATEGORIE_SERVICE_NAME));
            setFavoriService((IFavoriService) ApplicationCreateur.APPLICATION_CONTEXT.getBean(ApplicationCreateur.FAVORI_SERVICE_NAME));
            setLigneVitrineService((ILigneVitrineService) ApplicationCreateur.APPLICATION_CONTEXT.getBean(ApplicationCreateur.LIGNE_VITRINE_SERVICE_NAME));
            setMarchandService((IMarchandService) ApplicationCreateur.APPLICATION_CONTEXT.getBean(ApplicationCreateur.MARCHAND_SERVICE_NAME));
            setMembreService((IMembreService) ApplicationCreateur.APPLICATION_CONTEXT.getBean(ApplicationCreateur.MEMBRE_SERVICE_NAME));
            setVitrineService((IVitrineService) ApplicationCreateur.APPLICATION_CONTEXT.getBean(ApplicationCreateur.VITRINE_SERVICE_NAME));
            setProduitService((IProduitService) ApplicationCreateur.APPLICATION_CONTEXT.getBean(ApplicationCreateur.PRODUIT_SERVICE_NAME));
     ...
     * @throws ApplicationException S'il y a une erreur
     */
