// Fichier InvalidPrimaryKeyRequestException.java
// Auteur : Gilles Bénichou
// Date de création : 2014-08-24

package ca.qc.collegeahuntsic.weblab5.exception.dao;

/**
 * Cette exception est utilisée en cas de problème avec la requête de la clef primaire d'un DTO.
 *
 * @author Gilles Benichou
 */
public class InvalidPrimaryKeyRequestException extends Exception {
     ...
     */
    public InvalidPrimaryKeyRequestException() {
        super();
    }
     ...
     */
    public InvalidPrimaryKeyRequestException(String message) {
        super(message);
    }
     ...
     */
    public InvalidPrimaryKeyRequestException(Throwable cause) {
        super(cause);
    }
