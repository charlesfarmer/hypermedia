...
public class AchatDAO extends DAO implements IAchatDAO {
    ...
    public Bean add(Connexion connexion,
        ...
        try {
            ...
            try(
                PreparedStatement createPreparedStatement = connexion.getConnection().prepareStatement(AchatDAO.CREATE_REQUEST)) {
                ...
                createPreparedStatement.setString(2,
                    achatBean.getClientBean().getIdClient());
                createPreparedStatement.setTimestamp(3,
                    achatBean.getDateAchat());
    ...
    public AchatBean get(Connexion connexion,
        ...
        try {
            ...
            try(
                PreparedStatement readPreparedStatement = connexion.getConnection().prepareStatement(AchatDAO.READ_REQUEST)) {
    ...
    public void update(Connexion connexion,
        ...
        try {
            ...
            AchatBean achatBean = (AchatBean) bean;
            try(
                PreparedStatement updatePreparedStatement = connexion.getConnection().prepareStatement(AchatDAO.UPDATE_REQUEST)) {
    ...
    public void delete(Connexion connexion,
        ...
        try {
            ...
            AchatBean achatBean = (AchatBean) bean;
            try(
                PreparedStatement deletePreparedStatement = connexion.getConnection().prepareStatement(AchatDAO.DELETE_REQUEST)) {
    ...
    @Override
    public List<AchatBean> getAll(Connexion connexion,
        ...
        try {
            ...
            try(
                PreparedStatement getAllPreparedStatement = connexion.getConnection().prepareStatement(AchatDAO.GET_ALL_REQUEST)) {
                try(
