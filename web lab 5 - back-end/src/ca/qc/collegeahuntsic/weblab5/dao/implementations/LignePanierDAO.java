...
public class LignePanierDAO extends DAO implements ILignePanierDAO {
    ...
    public LignePanierDAO(Class<LignePanierBean> beanClass) throws InvalidDTOClassException {
        super(beanClass);
    }
    ...
    public Bean add(Connexion connexion,
        ...
        try {
            ...
            try(
                PreparedStatement createPreparedStatement = connexion.getConnection().prepareStatement(LignePanierDAO.CREATE_REQUEST)) {
                lignePanierBean.setIdLignePanier(LignePanierDAO.getPrimaryKey(connexion));
                createPreparedStatement.setString(1,
                    lignePanierBean.getIdLignePanier());
                createPreparedStatement.setString(2,
                    lignePanierBean.getClientBean().getIdClient());
                createPreparedStatement.setString(3,
                    lignePanierBean.getProduitBean().getIdProduit());
                createPreparedStatement.setInt(4,
                    lignePanierBean.getQuantite());
    ...
    public LignePanierBean get(Connexion connexion,
        ...
        try {
            ...
            try(
                PreparedStatement readPreparedStatement = connexion.getConnection().prepareStatement(LignePanierDAO.READ_REQUEST)) {
    ...
    public void update(Connexion connexion,
        ...
        try {
            ...
            LignePanierBean lignePanierBean = (LignePanierBean) bean;
            try(
                PreparedStatement updatePreparedStatement = connexion.getConnection().prepareStatement(LignePanierDAO.UPDATE_REQUEST)) {
    ...
    public void delete(Connexion connexion,
        ...
        try {
            ...
            LignePanierBean lignePanierBean = (LignePanierBean) bean;
            try(
                PreparedStatement deletePreparedStatement = connexion.getConnection().prepareStatement(LignePanierDAO.DELETE_REQUEST)) {
    ...
    @Override
    public List<LignePanierBean> getAll(Connexion connexion,
        ...
        try {
            ...
            try(
                PreparedStatement getAllPreparedStatement = connexion.getConnection().prepareStatement(LignePanierDAO.GET_ALL_REQUEST)) {
                try(
    ...
    private static String getPrimaryKey(Connexion connexion) throws DAOException {
        return DAO.getPrimaryKey(connexion,
            LignePanierDAO.CREATE_PRIMARY_KEY);
    }
    ...
    public List<LignePanierBean> findByClient(Connexion connexion,
        ...
        try {
            ...
            if(clientBean == null) {
                throw new InvalidCriterionException("Le client ne peut être null");
            }
            List<LignePanierBean> panier = Collections.emptyList();
            try(
                PreparedStatement findByClientPreparedStatement = connexion.getConnection().prepareStatement(LignePanierDAO.FIND_BY_CLIENT_REQUEST)) {
                findByClientPreparedStatement.setString(1,
    ...
    public void deleteByClient(Connexion connexion,
        ...
        try {
            ...
            try(
                PreparedStatement deleteByClientPreparedStatement = connexion.getConnection().prepareStatement(LignePanierDAO.DELETE_BY_CLIENT_REQUEST)) {
