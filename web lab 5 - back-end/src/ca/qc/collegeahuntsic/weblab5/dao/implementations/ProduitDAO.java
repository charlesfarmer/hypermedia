...
public class ProduitDAO extends DAO implements IProduitDAO {
    ...
    public ProduitDAO(Class<ProduitBean> beanClass) throws InvalidDTOClassException {
        super(beanClass);
    }
    ...
    public Bean add(Connexion connexion,
        ...
        try {
            ...
            try(
                PreparedStatement createPreparedStatement = connexion.getConnection().prepareStatement(ProduitDAO.CREATE_REQUEST)) {
                ...
                createPreparedStatement.setString(3,
                    produitBean.getDescription());
                createPreparedStatement.setString(4,
                    produitBean.getStockBean().getIdStock());
    ...
    public ProduitBean get(Connexion connexion,
        ...
        try {
            ...
            try(
                PreparedStatement readPreparedStatement = connexion.getConnection().prepareStatement(ProduitDAO.READ_REQUEST)) {
    ...
    public void update(Connexion connexion,
        ...
        try {
            ...
            ProduitBean produitBean = (ProduitBean) bean;
            try(
                PreparedStatement updatePreparedStatement = connexion.getConnection().prepareStatement(ProduitDAO.UPDATE_REQUEST)) {
    ...
    public void delete(Connexion connexion,
        ...
        try {
            ...
            ProduitBean produitBean = (ProduitBean) bean;
            try(
                PreparedStatement deletePreparedStatement = connexion.getConnection().prepareStatement(ProduitDAO.DELETE_REQUEST)) {
    ...
    @Override
    public List<ProduitBean> getAll(Connexion connexion,
        ...
        try {
            ...
            try(
                PreparedStatement getAllPreparedStatement = connexion.getConnection().prepareStatement(ProduitDAO.GET_ALL_REQUEST)) {
                try(
