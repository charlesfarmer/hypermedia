...
public class UnitTests {
    ...
    public static void main(String[] args) {
        try {
            ...
            MagasinCreateur magasin = new MagasinCreateur(args[0],
                args[1],
                args[2],
                args[3]);
    ...
    private static void unitTestLigneFacture(MagasinCreateur magasin) throws ServiceException {
        ...
        profilBean = magasin.getProfilService().add(magasin.getConnexion(),
            profilBean);
        clientBean.setProfilBean(profilBean);
        clientBean = magasin.getClientService().add(magasin.getConnexion(),
            clientBean);
        achatBean.setClientBean(clientBean);
        achatBean.setDateAchat(new Timestamp(System.currentTimeMillis()));
        achatBean = magasin.getAchatService().add(magasin.getConnexion(),
            achatBean);
        ...
        stockBean = magasin.getStockService().add(magasin.getConnexion(),
            stockBean);
        produitBean.setStockBean(stockBean);
        produitBean = magasin.getProduitService().add(magasin.getConnexion(),
            produitBean);
        ...
        ligneFactureBean = magasin.getLigneFactureService().add(magasin.getConnexion(),
            ligneFactureBean);

        System.out.println("\n\n##### ADD \n\n"
            + ligneFactureBean.toString());

        ligneFactureBean = magasin.getLigneFactureService().get(magasin.getConnexion(),
            ligneFactureBean);
        ...
        magasin.getLigneFactureService().update(magasin.getConnexion(),
            ligneFactureBean);
        ...
        System.out.println("\n\n##### FIND BY ACHAT\n\n");
        for(LigneFactureBean b : magasin.getLigneFactureService().findByAchat(magasin.getConnexion(),
            achatBean)) {
            System.out.println(b.toString());
        }

        magasin.getLigneFactureService().delete(magasin.getConnexion(),
            ligneFactureBean);
        magasin.getAchatService().delete(magasin.getConnexion(),
            achatBean);
        magasin.getProduitService().delete(magasin.getConnexion(),
            produitBean);
        magasin.getClientService().delete(magasin.getConnexion(),
            clientBean);
        magasin.getStockService().delete(magasin.getConnexion(),
            stockBean);
        magasin.getProfilService().delete(magasin.getConnexion(),
            profilBean);
    ...
    private static void unitTestAchat(MagasinCreateur magasin) throws ServiceException,
        ...
        achatBean = magasin.getAchatService().get(magasin.getConnexion(),
            achatBean);
    ...
    private static void unitTestLignePanier(MagasinCreateur magasin) throws ServiceException {
        ...
        magasin.getLignePanierService().add(magasin.getConnexion(),
            lignePanierBean);

        System.out.println("\n\n##### ADD \n\n"
            + lignePanierBean.toString());

        lignePanierBean = magasin.getLignePanierService().get(magasin.getConnexion(),
            lignePanierBean);
        ...
        magasin.getLignePanierService().update(magasin.getConnexion(),
            lignePanierBean);
        ...
        System.out.println("\n\n##### FIND BY CLIENT \n\n");
        for(LignePanierBean b : magasin.getLignePanierService().findByClient(magasin.getConnexion(),
            lignePanierBean.getClientBean())) {
            System.out.println(b.toString());
        }

        magasin.getLignePanierService().deleteByClient(magasin.getConnexion(),
            clientBean);

        System.out.println("\n\n##### DELETE BY CLIENT \n\n");

        magasin.getLignePanierService().delete(magasin.getConnexion(),
            lignePanierBean);
        magasin.getProduitService().delete(magasin.getConnexion(),
            produitBean);
        magasin.getStockService().delete(magasin.getConnexion(),
    ...
    private static void unitTestProduit(MagasinCreateur magasin) throws ServiceException {
        ...
        produitBean = magasin.getProduitService().get(magasin.getConnexion(),
            produitBean);
        ...
        magasin.getProduitService().update(magasin.getConnexion(),
            produitBean);
    ...
    private static void unitTestStock(MagasinCreateur magasin) throws ServiceException {
        ...
        magasin.getStockService().add(magasin.getConnexion(),
            stockBean);

        System.out.println("\n\n##### ADD \n\n"
            + stockBean.toString());

        stockBean = magasin.getStockService().get(magasin.getConnexion(),
            stockBean);
        ...
        magasin.getStockService().update(magasin.getConnexion(),
            stockBean);
    ...
    private static void unitTestProfil(MagasinCreateur magasin) throws ServiceException {
        ...
        profilBean = magasin.getProfilService().get(magasin.getConnexion(),
            profilBean);
        ...
        magasin.getProfilService().update(magasin.getConnexion(),
            profilBean);
    ...
    private static void unitTestClient(MagasinCreateur magasin) throws ServiceException {
        ...
        clientBean = magasin.getClientService().get(magasin.getConnexion(),
            clientBean);
        ...
        magasin.getClientService().update(magasin.getConnexion(),
            clientBean);

        System.out.println("\n\n##### UPDATE \n\n"
            + clientBean.toString());

        clientBean = magasin.getClientService().findByEmail(magasin.getConnexion(),
            clientBean.getEmail());
