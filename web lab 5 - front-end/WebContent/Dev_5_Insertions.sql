...
insert into Produit values (SEQ_ID_STOCK.NEXTVAL,'Console Xbox','Jouez avec vos nombreaux 3 amis!',2);
insert into Produit values (SEQ_ID_STOCK.NEXTVAL,'Bottes de cowboy','Prenez vous pour un vrai homme du far west et faites vous arrêter par la police',3);
insert into Produit values (SEQ_ID_STOCK.NEXTVAL,'Harry Potter de lordre du phénix','Harry Potter passe lannée la plus plate de sa vie à Poudlard',4);
insert into Produit values (SEQ_ID_STOCK.NEXTVAL,'Bague en or','En or',5);
insert into Produit values (SEQ_ID_STOCK.NEXTVAL,'Tondeuse 360 noscope','Vous pouvez couper votre gazon, même les yeux fermés!',6);
insert into Produit values (SEQ_ID_STOCK.NEXTVAL,'Générateur de sons dapplaudissements','Vous en avez besoin, cest juste que vous ne le savez pas encore',7);
insert into Produit values (SEQ_ID_STOCK.NEXTVAL,'Salopette','One size fits all comme ils disent',8);
