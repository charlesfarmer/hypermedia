...
<html>
  <head>
    ...
    <link rel="stylesheet" href="css/viewMarchands/stylesheet.css" type="text/css"/>
    ...
    <script type="text/javascript" src="js/viewMarchands/viewMarchands.js"></script>
  </head>
  <body>
    <div id="index-template"><jsp:include page="/WEB-INF/jsp/viewMarchands/layout/viewMarchands.jsp" flush="true"/></div>
  </body>
</html>