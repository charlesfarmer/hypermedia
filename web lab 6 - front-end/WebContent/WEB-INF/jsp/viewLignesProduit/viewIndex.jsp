...
<html>
  <head>
    ...
    <link rel="stylesheet" href="css/viewLignesProduit/stylesheet.css" type="text/css"/>
    ...
    <script type="text/javascript" src="js/viewLignesProduit/viewLignesProduit.js"></script>
  </head>
  <body>
    <div id="index-template"><jsp:include page="/WEB-INF/jsp/viewLignesProduit/layout/viewLignesProduit.jsp" flush="true"/></div>
  </body>
</html>