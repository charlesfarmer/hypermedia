<div id="template-page">
  <div id="template-header"><jsp:include page="/WEB-INF/jsp/viewTemplate/layout/viewHeader.jsp" flush="true"><jsp:param value="on" name="viewVitrines"/></jsp:include></div>
