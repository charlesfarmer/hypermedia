...
public interface Constants {
	 ...
	 */
	String APPLICATION_NAME = ApplicationConfigurator
			.getProperty(Constants.APPLICATION_NAME_ID);

	/**
	 * String literal for the quoted application name.
	 */
	String QUOTED_APPLICATION_NAME = Constants.QUOTE
			+ Constants.APPLICATION_NAME + Constants.QUOTE;
	...
	/**
	 * String literal for
	 * {@link ca.qc.collegeahuntsic.bibliotheque.servlet.startup.ApplicationConfiguratorServlet}
	 * object init parameter name.
	 */
	...
	String APPLICATION_CONFIGURATOR_INIT_MESSAGE = "Application configurator loaded for application " //$NON-NLS-1$
			+ Constants.QUOTED_APPLICATION_NAME + Constants.DOT;
	 ...
	 */
	String DEFAULT_LANGUAGE_ID = ApplicationConfigurator
			.getProperty("defaultLanguageId"); //$NON-NLS-1$

	/**
	 * String literal for the default country ID.
	 */
	String DEFAULT_COUNTRY_ID = ApplicationConfigurator
			.getProperty("defaultCountryId"); //$NON-NLS-1$
	 ...
	 */
	String DEFAULT_DATE_FORMAT = ApplicationConfigurator
			.getProperty("defaultDateFormat"); //$NON-NLS-1$

	/**
	 * Default simple date format from the default date format.
	 */
	SimpleDateFormat DEFAULT_SIMPLE_DATE_FORMAT = new SimpleDateFormat(
