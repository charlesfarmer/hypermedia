...
public interface Constants {
    ...
    /**
     * Default file path for membre pictures
     */
    String FILE_UPLOAD_CONFIGURATOR_FILE_PATH_PARAMETER_NAME = "fileUploadPath";

    /**
     * Default maximum file upload size for membre
     */
    String FILE_UPLOAD_CONFIGURATOR_MAX_FILE_SIZE_PARAMETER_NAME = "maxFileSize";

    /**
     * Default maximum file memory size for membre
     */
    String FILE_UPLOAD_CONFIGURATOR_MAX_MEM_SIZE_PARAMETER_NAME = "maxMemSize";
}
