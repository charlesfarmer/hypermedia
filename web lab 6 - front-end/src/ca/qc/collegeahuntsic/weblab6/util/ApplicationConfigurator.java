...
public final class ApplicationConfigurator {
	 ...
	 *            Resource bundle base name to use
	 */
	public static synchronized void init(String resourceBundleBaseName) {
		ApplicationConfigurator.resourceBundle = ResourceBundle
				.getBundle(resourceBundleBaseName);
	}
	...
	/**
	 * Indicates if a value associated with a property key exists and is equals
	 * to "on".
	 * 
	 * @param key
	 *            The property key to use
	 * @return If a value associated with a property key exists and is equals to
	 *         "on".
	 */
	public static boolean isEnabled(String key) {
		final String value = ApplicationConfigurator.getProperty(key);
		return value != null && Constants.ON.equals(value);
	}
}
